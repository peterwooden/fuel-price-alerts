module.exports = {
    up: async (client: any) => {
        return client.query(`
            CREATE FUNCTION get_alerts_at_time (t TIMESTAMPTZ) RETURNS TABLE(code TEXT, fuel_type TEXT, price NUMERIC, time_weighted_average NUMERIC)
            STABLE
            LANGUAGE SQL
            AS $$
    ...
    down: async (client: any) => {
        return client.query(`
            DROP FUNCTION get_alerts_at_time;
        `);
    }
}